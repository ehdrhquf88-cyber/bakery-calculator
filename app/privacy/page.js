...
const sections = [
  {
    title: "1. 개인정보의 처리 목적",
    body: [
      "빵쟁이들은 초대된 사용자의 Google 로그인을 통한 본인 확인, 서비스 접근 권한 관리, 레시피 계산 및 저장, 재료비 관리, 온도/pH 기록 관리, 공지사항 제공, 서비스 보안 및 오류 대응을 위해 개인정보를 처리합니다.",
  ...
  },
  {
    title: "9. 안전성 확보 조치",
    body: [
      "빵쟁이들은 초대 이메일 기반 접근 제한, Supabase Row Level Security, 인증된 사용자만 접근 가능한 서버 API, 관리자 권한 분리, 서버 전용 비밀키 관리 등을 통해 개인정보 보호를 위해 노력합니다.",
