...
const sections = [
  {
    title: "1. 개인정보의 처리 목적",
    body: [
      "빵쟁이들은 사용자의 Google 로그인을 통한 본인 확인, 서비스 접근 권한 관리, 레시피 계산 및 저장, 재료비 관리, 온도/pH 기록 관리, 공지사항 제공, 서비스 보안 및 오류 대응을 위해 개인정보를 처리합니다.",
  ...
  },
  {
    ...
    body: [
      ...
      "서비스 이용 데이터: 사용자가 입력한 레시피, 재료비 항목, 온도/pH 기록, 메모, 공지사항 읽음 여부",
  ...
  },
  {
    ...
    body: [
      ...
      "다만 Google 로그인, 데이터 저장, 배포 및 분석 기능을 제공하기 위해 아래의 처리위탁 및 외부 서비스가 사용됩니다.",
    ],
  },
  {
    ...
    body: [
      ...
      "Supabase: 사용자 인증, 프로필, 권한 정보, 레시피, 재료비, 온도/pH 기록, 공지사항 데이터 저장 및 동기화",
  ...
  },
  {
    title: "7. 관리자 열람 범위",
    body: [
      "관리자는 앱의 관리자 화면에서 사용자의 레시피 내용을 열람할 수 없으며, 사용자 계정 정보, 권한, 저장된 데이터 개수 등 서비스 관리에 필요한 최소한의 정보만 확인할 수 있습니다.",
      "다만 서비스 장애 대응, 보안 점검, 데이터 복구 등 운영상 필요한 경우에는 데이터베이스 관리자 권한으로 저장 데이터에 접근할 수 있습니다.",
    ],
  },
  {
  ...
  },
  {
    title: "9. 안전성 확보 조치",
    body: [
      "빵쟁이들은 Google 로그인 기반 인증, Supabase Row Level Security, 인증된 사용자만 접근 가능한 서버 API, 관리자 권한 분리, 서버 전용 비밀키 관리 등을 통해 개인정보 보호를 위해 노력합니다.",
      "사용자는 본인의 Google 계정과 기기 접근 권한을 안전하게 관리해야 하며, 공용 기기에서는 이용 후 로그아웃하는 것이 좋습니다.",
    ],
  },
  {
    title: "10. 쿠키 및 브라우저 저장소 이용",
    body: [
      ...
      <div className="mx-auto max-w-3xl">
        ...
        <section className="mt-6 rounded-xl border border-gray-200 bg-white p-5">
          ...
          <ul className="mt-3 space-y-2 text-sm font-bold leading-6 text-gray-600">
            ...
            <li>관리자는 앱에서 사용자 레시피 내용이 아니라 저장 데이터 개수 등 요약 정보를 확인합니다.</li>
